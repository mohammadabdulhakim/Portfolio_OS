      ...
      <div className="flex flex-col items-center justify-center gap-4 md:w-[60%] w-full">
        <div className="relative mb-8">
          <div className="links-circle w-full h-full rounded-full block absolute z-0 text-neutral-700">
            <animated.div style={opacityAnimation(1500)}>
            ...
            <animated.div style={opacityAnimation(2500)}>
            ...
            <animated.div style={opacityAnimation(2000)}>
            ...
            <animated.div style={opacityAnimation(3000)}>
        ...
        <div className="h-fit flex  justify-center flex-col">
          <animated.div style={textAnimation(3600, "40px")} className="text-2xl font-semibold text-start md:ml-20" >
            Hello There,
          </animated.div>
          <animated.div style={textAnimation(4000, "40px")} className="text-3xl font-semibold text-center" >
            I&apos;m Mohammad AbdulHakim 
            <span className="text-[15px] font-normal">
              {" "}Frontend web developer
            </span>
          </animated.div>
          <animated.div style={textAnimation(4300, "28px")} className="text-lg sm:text-xl text-gray-800 text-center md:mt-0 mt-14" >
            This is just a welcome page. You can visit{" "}
            <Link className="text-blue-600" target="_blank" href={`/portfolio`}>
              my portfolio{" "}
            </Link>
            ...
            {" "}and surf its{" "}
            <Link className="text-blue-600" target="_blank" href={`/pc/os`}>
              operating system
            </Link>
            {" "}to get a glimpse of my technical abilities. If you have any questions or comments, please feel free to contact me at{" "}
            <Link className="text-blue-600" target="_blank" href={"mailto:contact@abomisr.com"}>
              contact@abomisr.com
            </Link>
            .
          </animated.div>
